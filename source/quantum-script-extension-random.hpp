...
#ifndef QUANTUM_SCRIPT_EXTENSION_RANDOM_HPP
			...
			namespace Random {
				...
				class RandomContext:
					...
					public:
						...
						QUANTUM_SCRIPT_EXTENSION_RANDOM_EXPORT RandomContext();
				};

				QUANTUM_SCRIPT_EXTENSION_RANDOM_EXPORT RandomContext *getContext();

				QUANTUM_SCRIPT_EXTENSION_RANDOM_EXPORT void initExecutive(Executive *executive, void *extensionId);
				QUANTUM_SCRIPT_EXTENSION_RANDOM_EXPORT void registerInternalExtension(Executive *executive);
