...
echo -^> local-release quantum-script-extension-random
...
call :cmdX xyo-cc quantum-script-extension-random --archive-release-sha512 --version-file=source/quantum-script-extension-random.version.ini
